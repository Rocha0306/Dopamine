...
public class FuncionalidadesCalculadoraDeDopamina {
    ...
    public void MensagensAposCadastro() {
    ...
    public void MensagensAposLogin() {
        System.out.println("Seja bem vindo de volta a Calculadora de Dopamina!");
    }




    protected void FuncionalidadeDoAplicativo() {
